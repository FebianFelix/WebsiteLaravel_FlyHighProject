        ...
        <form action="{{ route('login') }}" method="POST">
         @csrf
          ...
          @endif
            ...
            <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
            <button type="button" onclick="window.location.href='{{ url('/index') }}'" class="btn btn-secondary btn-lg text-light my-2 py-3" style="width: 100%; border-radius: 30px; font-weight: 600;">Cancel</button>
            </div>

          </form><br>
          <p align="center">i don't have any account <a href="{{ url('/register') }}" class="text-warning" style="font-weight:600;text-decoration:none;">Register Here</a></p>
        </div>
      </div>
    </div>
  </section>
